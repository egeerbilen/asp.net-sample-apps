...
namespace FluentValidationDemo.Validators
{
    public class AddressValidator : AbstractValidator<Address>
    {
        ...
        private bool ValidPostCode(string postalCode)
        {
            ...
            // Bu metot, bir posta kodunun geçerliliğini kontrol etmek için özel bir mantık ekleyebilir.
            // Örneğin, belirli bir formata uyması, bir veritabanında kontrol edilmesi gibi işlemler yapılabilir.
            return true;
        }
    }
}
