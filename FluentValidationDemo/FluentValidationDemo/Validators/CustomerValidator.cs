...
{
    public class CustomerValidator : AbstractValidator<Customer> // AbstractValidator<Customer>: Bu, Customer sınıfının doğrulama kurallarını tanımlayan bir soyut sınıftan türetilen CustomerValidator sınıfını oluşturur.
    {
